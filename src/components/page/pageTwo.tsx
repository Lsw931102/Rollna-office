...
function PageTwo() {
    return (
        <Box h="100%" h="100%" w={{ base: '100%', lg: '1280px' }} m="0 auto">
            ...
            <Flex alignItems="center" p={{ base: px2vw(10), lg: '10px' }}>
                ...
                <Box ml={{ base: px2vw(20), lg: '20px' }} >
                    <List spacing={3}>
                        <ListItem>
                            <Flex alignItems="center">
                                ...
                                <Box color="black" p="10px">
                                    <Text fontSize={{ base: px2vw(16), lg: '16px' }} fontWeight={{ base: px2vw(700), lg: '700' }}>
                                        Convenient
                    </Text>
                                    <Text fontSize={{ base: px2vw(14), lg: '14px' }} lineHeight={{ base: px2vw(24), lg: '24px' }} noOfLines={[3]}>
                        ...
                        <ListItem>
                            <Flex alignItems="center">
                                <Image src={interoperability} ignoreFallback width={{ base: px2vw(32), lg: '32px' }} />
                                <Box color="black" p="10px">
                                    <Text fontSize={{ base: px2vw(16), lg: '16px' }} fontWeight={{ base: px2vw(700), lg: '700' }}>
                                        Convenient
                    </Text>
