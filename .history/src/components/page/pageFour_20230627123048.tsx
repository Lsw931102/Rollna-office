...
function PageFour() {
  ...
  const handleOnScroll = () =>{
    const { scrollTop, clientHeight, scrollHeight, clientHeight, scrollHeight } = targetRef.current;
    console.log(scrollTop)

  }
  return (
    <Box w={{ base: '100%', lg: '1280px' }} m="0 auto" h='100%' overflow='auto' ref='targetRef' onScrollCapture={() => handleOnScroll()}>
      <Center
