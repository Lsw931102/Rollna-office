    ...
    <Box w={{ base: '100%', lg: '1280px' }} m="0 auto" h='100%' overflow='auto' className='fourBox' ref={containerRef}>
      ...
      <Box position="relative" h={{ base: px2vw(571), lg: '575px' }}>
        ...
        <Box position="absolute" right="10%">
          <Flex>
            <Box position='relative' mr={{ base: px2vw(16), lg: '16px' }}>
              ...
              <Box h={{ base: px2vw(80), lg: '80px' }} w={{ base: px2vw(1), lg: '1px' }} bg='black' position='absolute' left='50%'></Box>
        ...
        <Box position="absolute" left="25%" bottom={{ base: px2vw(0), lg: '0px' }}>
          <Flex>
            <Box position='relative' mr={{ base: px2vw(16), lg: '16px' }}>
              <Box h={{ base: px2vw(52), lg: '52px' }} w={{ base: px2vw(1), lg: '1px' }} bg='black' position='absolute' top={{ lg: '-52px' }} left='50%'></Box>
        ...
        <Box position="absolute" bottom={{ base: px2vw(180), lg: '180px' }} right="22%">
          <Flex>
            <Box position='relative' mr={{ base: px2vw(16), lg: '16px' }}>
              <Box h={{ base: px2vw(52), lg: '52px' }} w={{ base: px2vw(1), lg: '1px' }} bg='black' position='absolute' top={{ lg: '-52px' }} left='50%'></Box>
