      ...
      <Box position="relative" h={{ base: px2vw(541), lg: '541px' }}>
        ...
        <Box position="absolute" bottom={{ base: px2vw(180), lg: '180px' }} right="15%">
          <Flex>
            ...
            <List w={{ base: px2vw(180), lg: '180px' }}>
              <ListItem fontSize={{ base: px2vw(16), lg: '16px' }} fontWeight='600'>Kickoff the project:</ListItem>
              <ListItem fontSize={{ base: px2vw(14), lg: '14px' }}>1.Research the Market and Technology.</ListItem>
              <ListItem fontSize={{ base: px2vw(14), lg: '14px' }}>2.Start Project Design.</ListItem>
            </List>
          </Flex>
        </Box>
      </Box>
