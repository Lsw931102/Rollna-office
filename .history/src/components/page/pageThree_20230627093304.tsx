          ...
          >
            <SwiperSlide>
              <Flex align="center">
                ...
                <Image src={Baowr01} data-swiper-parallax-opacity="0" data-swiper-parallax-duration="800" ignoreFallback h={{ base: px2vw(400), lg: '400px' }} />
              </Flex>
            </SwiperSlide>
            <SwiperSlide>
              <Flex align="center">
                ...
                <Image src={Baowr02} data-swiper-parallax-opacity="0" data-swiper-parallax-duration="800" ignoreFallback h={{ base: px2vw(400), lg: '400px' }} />
              </Flex>
            </SwiperSlide>
            <SwiperSlide>
              <Flex align="center">
                ...
                <Image data-swiper-parallax-opacity="0" data-swiper-parallax-duration="800" src={Baowr03} ignoreFallback h={{ base: px2vw(400), lg: '400px' }} />
              </Flex>
            </SwiperSlide>
          </Swiper>
        </Box>
