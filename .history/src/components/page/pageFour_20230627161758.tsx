      ...
      <Box position="relative" h={{ base: px2vw(541), lg: '541px' }}>
        ...
        <Box position="absolute" bottom={{ base: px2vw(180), lg: '180px' }} right="15%">
          <Flex>
            ...
            <OrderedList w={{ base: px2vw(180), lg: '180px' }}>
              <Text mr='-5px' fontSize={{ base: px2vw(16), lg: '16px' }} fontWeight='600'>Kickoff the project:</Text>
              <ListItem fontSize={{ base: px2vw(14), lg: '14px' }}>Research the Market and Technology.</ListItem>
              <ListItem fontSize={{ base: px2vw(14), lg: '14px' }}>Start Project Design.</ListItem>
            </OrderedList>
          </Flex>
        </Box>
      </Box>
